...
uses untLogin, untCadastroCidade, untListagemCidade, untCadastroUsuario,
  ...
  untRptOrdemServico, untBackup, untDespesa;

procedure TfrmPrincipal.Backup1Click(Sender: TObject);
begin
ShowMessage('Entrar no diretório: D:\TCC 2015\PROJETO, e executar o arquivo backup como adiministrador.');
end;
